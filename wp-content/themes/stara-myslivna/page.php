<?php get_header(); ?>
        ...
        <main id="main-content" role="main">
            ...
            <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
                ...
                // Slugy kde NEMÁ být hero foto (klient 29.4.2026)
                $no_hero_slugs = [
                    'o-restauraci','akce','sluzby','shop','menu','menu-skupiny',
                    'zajimavosti','foto-pokrmu','sefkuchari','videa','publicita','letaky','igc',
                    'jidelni-listek','napojovy-listek','menu-en','drink-menu-en','group-menu-en','speisekarte-de','getrankekarte-de',
                    'souvenirs','postcard','karty','plysaci','darkove-poukazy',
                    'kontakty',
                ];
                $show_hero = !in_array($slug, $no_hero_slugs);
                $hero_map = [
                    'o-restauraci'        => 'stara-myslivna-uvod-restaurace-interier.webp',
                    'interier'            => 'stara-myslivna-uvod-restaurace-interier.webp',
                    'exterior'            => 'stara-myslivna-uvod-restaurace-exterier.webp',
                    'exterier'            => 'stara-myslivna-uvod-restaurace-exterier.webp',
                    'oburka'              => 'stara-myslivna-uvod-restaurace-oburka.webp',
                    'zajimavosti'         => 'stara-myslivna-uvod-restaurace-zajimavosti.webp',
                    'historie'            => 'stara-myslivna-historie-budova1900-uvod-01.webp',
                    'foto-pokrmu'         => 'stara-myslivna-uvod-restaurace-pokrmy.webp',
                    'sefkuchari'          => 'stara-myslivna-uvod-restaurace-sefkuchari.webp',
                    'videa'               => 'stara-myslivna-uvod-restaurace-videa.webp',
                    'publicita'           => 'stara-myslivna-uvod-restaurace-publicita.webp',
                    'letaky'              => 'stara-myslivna-uvod-restaurace-letaky.webp',
                    'igc'                 => 'stara-myslivna-uvod-restaurace-igc.webp',
                    'historie'            => 'stara-myslivna-uvod-restaurace-historie.webp',
                    ...
                    'sluzby'              => 'stara-myslivna-uvod-sluzby-snezcozmuzes.webp',
                    'snez-co-zmuzes'      => 'stara-myslivna-uvod-sluzby-snezcozmuzes.webp',
                    'svatby'              => 'stara-myslivna-uvod-sluzby-svatby.webp',
                    'lovecka-chata'       => 'stara-myslivna-uvod-sluzby-lovecka-chata.webp',
                    ...
                    'hony'                => 'stara-myslivna-uvod-sluzby-hony.webp',
                    ...
                    'shop'                => 'stara-myslivna-shop-uvod-plysaci.jpg',
                    ...
                    'plysaci'             => 'stara-myslivna-shop-uvod-plysaci.jpg',
