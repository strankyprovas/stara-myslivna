        ...
        <main id="main-content" role="main">
            ...
            <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
                ...
                $hero_map = [
                    ...
                    'sluzby'              => 'chata_uvod.jpg',
                    'snez-co-zmuzes'      => 'snez_flyer.jpg',
                    'svatby'              => 'stara-myslivna-uvod-web-svatby.webp',
                ...
                <?php
                // Podstránky jako foto dlaždice (jen přímé děti, ne hluboké nested)
                $children = get_pages([
                    'parent'      => get_the_ID(),
