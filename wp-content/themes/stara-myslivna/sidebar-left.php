<aside id="left-sidebar" role="complementary">
    ...
    <?php else : ?>
        ...
        if (empty($pokrmy)) {
            // Aktualizováno 13.5.2026 - klient: prolínačka má obsahovat pokrmy ze sekce Pokrmy
            $pokrmy = [
                ['src' => $tpl . '/stara-myslivna-pokrmy-predkrm-zverinova-pastika-01.webp', 'alt' => 'Zvěřinová paštika'],
                ['src' => $tpl . '/stara-myslivna-pokrmy-polevka-bullshot-05.webp', 'alt' => 'Bull shot – bažantí vývar'],
                ['src' => $tpl . '/stara-myslivna-pokrmy-zverinovy-gulas-12.webp', 'alt' => 'Zvěřinový guláš'],
                ['src' => $tpl . '/stara-myslivna-pokrmy-jeleni-sipkova-13.webp', 'alt' => 'Jelení se šípkovou'],
                ['src' => $tpl . '/stara-myslivna-pokrmy-peceny-bazant-15.webp', 'alt' => 'Pečený bažant'],
                ['src' => $tpl . '/stara-myslivna-pokrmy-vypecky-diviocak-16.webp', 'alt' => 'Výpečky z divočáka'],
                ['src' => $tpl . '/stara-myslivna-pokrmy-jeleni-steak-lisky-18.webp', 'alt' => 'Jelení steak s liškami'],
                ['src' => $tpl . '/stara-myslivna-pokrmy-misa-4osoby-maso-31.webp', 'alt' => 'Mísa pro 4 osoby'],
                ['src' => $tpl . '/stara-myslivna-pokrmy-dezerty-staroceske-livance-44.webp', 'alt' => 'Staročeské lívance'],
            ];
        }
        ?>
        <div class="sidebar-block">
