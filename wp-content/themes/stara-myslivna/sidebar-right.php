    ...
    <?php else : ?>
                ...
                <p style="text-align:center;margin-top:6px;">
                    <figure class="gallery-item" style="margin:0;">
                        <div class="gallery-icon">
                            <a href="<?php echo esc_url($tpl . '/snez_flyer.jpg'); ?>">
                                <img src="<?php echo esc_url($tpl . '/snez_flyer.jpg'); ?>"
                                     alt="Sněz co zmůžeš" style="width:100%;display:block;cursor:zoom-in;">
                            </a>
                        </div>
                    </figure>
                </p>
        ...
        <div class="sidebar-block">
            ...
            <div class="sidebar-block-content">
                ...
                ?>
                <p style="text-align:center;margin-top:6px;">
                    <img src="<?php echo esc_url($tpl . '/strop_bazanti.jpg'); ?>"
                         alt="Nástropní malba letící pernaté zvěře" style="max-width:100%;height:auto;display:block;margin:0 auto;"
