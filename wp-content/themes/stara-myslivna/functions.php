...
function myslivna_enqueue() {
    // Cache-busting přes filemtime – verze se mění s každou úpravou souboru
    $css_ver = @filemtime( get_stylesheet_directory() . '/style.css' ) ?: '1.0.0';
    $js_ver  = @filemtime( get_template_directory() . '/js/main.js' ) ?: '1.0.0';
    wp_enqueue_style( 'myslivna-style', get_stylesheet_uri(), [], $css_ver );
    wp_enqueue_script( 'myslivna-main', get_template_directory_uri() . '/js/main.js', [], $js_ver, true );
